...
const CardComponent = ({ image, develop, drop, author, description, price, id }) => {
    return (
        <div className='rounded-[6px] shadow-neon bg-whitee md:h-[466px] xxs:h-auto md:pb-0 xxs:pb-[26px]'>
            ...
            <div className='px-5'>
                <p className='text-light-dark text-lg font-semibold pt-5'>{develop}</p>
                ...
                <div className='pt-6 flex justify-between'>
                    <Link href={`/courses/${id}`} className='cursor-pointer text-light-dark text-sm font-medium flex items-center gap-[5px]'>
                        Enroll Now
